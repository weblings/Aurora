...
| [debugging-method.md](debugging-method.md) | evidence, verification, oracles, timing | 10 | debugging/verification method |
| [architecture-process.md](architecture-process.md) | splits, duplication, reload, presence | 13 | architecture or process decision |

...
or device discovery, read `docs/lessons/input.md`.

## How to use this skill

1. Grep `Tags:`/`Applies-when:` in `docs/lessons/input.md` for the
...
3. File new capture-specific gotchas here per `docs/lessons/README.md`

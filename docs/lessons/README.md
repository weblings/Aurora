...
| [windows-env.md](windows-env.md) | processes, installers, ACLs, probing | 11 | Windows-environment specific |
| [debugging-method.md](debugging-method.md) | evidence, verification, oracles, timing | 19 | debugging/verification method |

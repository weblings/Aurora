...
// stays with flock, untouched). A second instance reads it to name the
// holder and to probe whether its HTTP port answers, distinguishing a
// healthy handoff from a holder wedged before its bind (Aurora-kwn).
